<%@ page import="com.hezhongli.model.Product" %>
<%@ page import="com.hezhongli.model.Category" %>
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<c:forEach var="p" items="${productList}">
						<tr>
							...
							<td class="">
							<a class="cart_quantity_delete" href="<%=basePath%>admin/productEdit?productId=${p.categoryId}" >
							<i class="fa fa-edit">Edit</i></a>&nbsp;
							<a class="cart_quantity_delete" href="<%=basePath%>admin/productDelete?productId=${p.categoryId}">
