			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.hezhongli.model.Order o=(com.hezhongli.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.hezhongli.dao.UserDao userDao=new com.hezhongli.dao.UserDao();
						...
						<%
							...
							String paymentType=com.hezhongli.model.Payment.findByPaymentId(con,n);
							 %>
